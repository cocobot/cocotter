...
use esp_idf_svc::{hal::{gpio::{AnyInputPin, InputPin}, pcnt::{Pcnt, PcntChannel, PcntChannelConfig, PcntControlMode, PcntCountMode, PcntDriver, PcntEvent, PcntEventType, PinIndex}, peripheral::Peripheral}, sys::EspError};
